...
<table>
    <tr>
        <td style="text-align:center;font-size: 12px;font-weight: bold "><?php echo $title ?></td>        
    </tr>
</table>
<br>
<br>
...
<table border="1" padding="2" >
    ...
    <?php 
        $no =  1;
        // $next_month_prediction = array();
        foreach( $next_month_prediction as $ind => $row ):
    ?>
    <?php 
        if( FALSE && $no == count( $rows ) ):
    ?>
